"""
PPO v2 training run: 21x21 observation window, 512-dim extractor, 20M steps.

The wider window is the documented fix for the level-4 collision rate - the agent was
under-reading the obstacle channel because walls and boxes alias together inside a 15x15
view. Shared scaffolding lives in hivemind_env/training.py.

Models produced here are NOT loadable into a 15x15 env, and v1 checkpoints are not
loadable here. See hivemind_env/env.py for why.
"""
import os
...
from hivemind_env.env import OBS_SIZE_V2
...
if __name__ == "__main__":
    ...
    OBS_SIZE          = OBS_SIZE_V2   # 21x21 - the v2 change
    FEATURES_DIM      = 512
    ...
    model.learn(
        ...
        tb_log_name="PPO_v2",       # -> tensorboard_logs_ppo_v2/PPO_v2_1/
